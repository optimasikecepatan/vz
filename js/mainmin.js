!function() {
    ...
    let c = function() {
        ...
        o.setAttribute("class", "nav-more-toggle"),
        o.setAttribute("aria-label", "More"),
        o.innerHTML = '<span class="icon-svg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M5 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm14 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-7 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg></span>';
        let s = document.createElement("ul");
        s.setAttribute("class", "sub-menu"),
...
function() {
    ...
    function r(o) {
        let r = o || s;
        "dark" == r ? (n.style.display = "flex",
        e.style.display = "none") : (e.style.display = "flex",
        n.style.display = "none"),
        t.length > 0 && r && ("dark" == r ? (i.forEach(function(t) {
            t.classList.contains("bg-light") && (t.classList.remove("bg-light"),
            t.classList.add("bg-dark"),
            t.classList.add("skin-change"))
        }),
        document.body.classList.add("site-dark")) : (i.forEach(function(t) {
            t.classList.contains("skin-change") && (t.classList.remove("bg-dark"),
            t.classList.add("bg-light")),
            t.classList.remove("skin-change")
        }),
        document.body.classList.remove("site-dark"))),
        t.length <= 0 && localStorage.removeItem("th90-skin")
    }
...
function() {
    ...
    t && (window.addEventListener("scroll", function(t) {
        ...
        this.scrollY > 400 ? (e.classList.add("show"),
        n && n.classList.add("top-pos")) : (e.classList.contains("show") && e.classList.remove("show"),
        n && n.classList.contains("top-pos") && n.classList.remove("top-pos"))
    }),
...
function(t, e) {
    ...
    e.errorCheck = function() {
        var t = [];
        if (this.element || t.push("Bad element: " + this.element),
        ...
        t.length)
            throw Error("[Colcade error] " + t.join(". "))
    }
    ,
    e.reload = function() {
        this.updateColumns(),
    ...
    e.layoutItem = function(t) {
        ...
        this.activeColumns[n].appendChild(t),
        this.columnHeights[n] += t.offsetHeight || 1
    }
    ,
    e.append = function(t) {
...
if (null !== posts_grid)
    var posts_colc = new Colcade(posts_grid,{
        columns: ".grid-col",
        items: ".post-card"
    });
...
!function() {
        ...
        if (!nextLink || !postsContainer) return;
        
        let currentPage = 1;
        const baseUrl = nextLink.href.split('page=')[0];
        const searchParams = new URLSearchParams(nextLink.href.split('?')[1]);
        const totalResults = parseInt(searchParams.get('result')) || 12;
        ...
        loadMoreButton.addEventListener('click', async function(e) {
            ...
            try {
                ...
                loadMoreButton.appendChild(loader);
                
                // Construct next page URL
                currentPage++;
                const nextPageUrl = `${baseUrl}page=${currentPage}&result=${totalResults}`;
                ...
                const newPosts = doc.querySelectorAll('.latest-posts article');
                ...
                newPosts.forEach(post => {
                    if (postsContainer.classList.contains('posts-block')) {
                        ...
                        // Assuming posts_colc is defined elsewhere
                        window.posts_colc?.append(post);
                    }
                });
                ...
                // Check if we should remove the load more button
                ...
                loadMoreButton.querySelector('.loader')?.remove();
            }
        });
    })(),
function(t, e) {
    ...
    function $(t, n) {
        ...
        return n.hasOwnProperty("classes") && (i.classes = Object.assign({}, t.classes, n.classes),
        ["direction", "type", "slide", "arrow", "nav"].forEach(function(o) {
            n.classes.hasOwnProperty(o) && (i.classes[o] = e(e({}, t.classes[o]), n.classes[o]))
        })),
        n.hasOwnProperty("breakpoints") && (i.breakpoints = Object.assign({}, t.breakpoints, n.breakpoints)),
        i
    }
    var b = function() {
        function t() {
      ...
      , w = function() {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                p(t) ? this._c = function t(e, n, i) {
                    var o = {};
                    for (var s in n)
                        v(n[s]) ? o[s] = n[s](e, o, i) : f("Extension must be a function");
                    for (var r in o)
                        v(o[r].mount) && o[r].mount();
                    return o
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                return this.settings = $(this.settings, t),
    ...
    function S(t, e) {
        var n, i, o, s, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, a = 0, u = function() {
            a = !1 === r.leading ? 0 : k(),
            n = null,
            s = t.apply(i, o),
            n || (i = o = null)
            ...
            a = c,
            s = t.apply(i, o),
            n || (i = o = null)) : n || !1 === r.trailing || (n = setTimeout(u, l)),
            s
        };
    ...
    var U = {
        Html: function(t, e, n) {
            var i = {
                mount: function() {
                    ...
                    this.track = this.root.querySelector(E),
                    this.collectSlides()
                },
            ...
            return y(i, "root", {
                ...
                set: function(t) {
                    ...
                    null !== t ? i._r = t : f("Root element must be a existing Html node")
                }
            }),
            y(i, "track", {
                get: function() {
        ...
        Translate: function(t, e, n) {
            var i = {
                set: function(n) {
                    ...
                    }).mutate(n), a = "translate3d(".concat(-1 * r, "px, 0px, 0px)");
                    e.Html.wrapper.style.mozTransform = a,
                    e.Html.wrapper.style.webkitTransform = a,
                    e.Html.wrapper.style.transform = a
                },
                remove: function() {
            ...
            var i = {
                apply: function(t) {
                    for (var n = 0, i = t.length; n < i; n++) {
                        var o = t[n].style
                          , s = e.Direction.value;
                        o[_[s][0]] = 0 !== n ? "".concat(this.value / 2, "px") : "",
                        n !== t.length - 1 ? o[_[s][1]] = "".concat(this.value / 2, "px") : o[_[s][1]] = ""
                    }
                },
                remove: function(t) {
        ...
        Clones: function(t, e, n) {
            var i = {
                    ...
                    if (i.length > 0)
                        for (var u = +!!t.settings.peek, c = s + u + Math.round(s / 2), l = i.slice(0, c).reverse(), f = i.slice(-1 * c), d = 0; d < Math.max(a, Math.floor(s / i.length)); d++) {
                            for (var h = 0; h < l.length; h++) {
                                ...
                                p.classList.add(r.slide.clone),
                                n.push(p)
                            }
                            for (var v = 0; v < f.length; v++) {
                                var m = f[v].cloneNode(!0);
                                m.classList.add(r.slide.clone),
                                n.unshift(m)
                            }
                        }
                    return n
                ...
                append: function() {
                    for (var t = this.items, n = e.Html, i = n.wrapper, o = n.slides, s = Math.floor(t.length / 2), r = t.slice(0, s).reverse(), a = t.slice(-1 * s).reverse(), u = "".concat(e.Sizes.slideWidth, "px"), c = 0; c < a.length; c++)
                        i.appendChild(a[c]);
                    for (var l = 0; l < r.length; l++)
                        i.insertBefore(r[l], o[0]);
            ...
            var i = {
                ...
                calculate: function() {
                    var e = this.move
                      ...
                      , r = 1;
                    if ("=" === s)
                        return t.settings.bound && d(o) > n ? void (t.index = n) : void (t.index = o);
                    if (">" !== s || ">" !== o) {
                        if ("<" !== s || "<" !== o) {
                            if ("|" === s && (r = t.settings.perView || 1),
                            ">" === s || "|" === s && ">" === o) {
                                var a, u, c, l, h, p = (a = r,
                                u = t.index,
                                t.isType("carousel") ? u + a : u + (a - u % a));
                                return p > n && (this._o = !0),
                                void (t.index = (c = p,
                                l = r,
                                c <= (h = i.length) ? c : t.isType("carousel") ? c - (h + 1) : t.settings.rewind ? i.isBound() && !i.isEnd() ? h : 0 : i.isBound() ? h : Math.floor(h / l) * l))
                            }
                            if ("<" === s || "|" === s && "<" === o) {
                                var v, m, g, y, $, b = (v = r,
                                m = t.index,
                                t.isType("carousel") ? m - v : (Math.ceil(m / v) - 1) * v);
                                return b < 0 && (this._o = !0),
                                void (t.index = (g = b,
                                y = r,
                                $ = i.length,
                                g >= 0 ? g : t.isType("carousel") ? g + ($ + 1) : t.settings.rewind ? i.isBound() && i.isStart() ? $ : Math.floor($ / y) * y : 0))
                            }
              ...
              , c = {
                ...
                move: function(i) {
                    if (!t.disabled) {
                        ...
                        if (!(180 * (o = Math.asin(Math.sqrt(p) / Math.sqrt(Math.abs(h << 2) + p))) / Math.PI < u))
                            return !1;
                        i.stopPropagation(),
                ...
                bindSwipeStart: function() {
                    ...
                    r && i.on(B[1], e.Html.wrapper, function(t) {
                        n.start(t)
                    }, u)
                },
                unbindSwipeStart: function() {
                    i.off(B[0], e.Html.wrapper, u),
                    i.off(B[1], e.Html.wrapper, u)
                },
            ...
            var i = new C
              ...
              , s = {
                ...
                resetArrowState: function() {
                    for (var e = t.settings, n = arguments.length, i = Array(n), o = 0; o < n; o++)
                        i[o] = arguments[o];
        ...
        Breakpoints: function(t, e, n) {
            ...
            return Object.assign(o, a.match(s)),
            i.on("resize", window, S(function() {
